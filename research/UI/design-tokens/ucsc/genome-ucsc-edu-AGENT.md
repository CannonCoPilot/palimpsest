# You are building UI in the genome.ucsc.edu design system.

Source: https://genome.ucsc.edu/cgi-bin/hgGateway
Extracted by designlang on 2026-06-10.

## Brand at a glance

- title         genome.ucsc.edu
- page intent   landing
- material      flat
- design grade  B
...
- families   Helvetica · Times · Arial
- weights    400 · 700
- base size  16px
...
```bash
npx designlang genome.ucsc.edu
```
...
Generated by designlang. Re-extract by running `npx designlang genome.ucsc.edu`.
