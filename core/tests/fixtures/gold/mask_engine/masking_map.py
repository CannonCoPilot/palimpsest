...
SUPPLEMENT: dict[int, list[dict]] = {
    ...
    # idx5 (Douay-Rheims) is built by bible_structure.build_dr_elements (CUSTOM_ELEMENTS[5]);
    # its full structure is materialized there, not via SUPPLEMENT/RULES.
    104: [
        {"type": "front_matter", "start_anchor": "<<BOF>>",
...
from bible_structure import build_dr_elements  # noqa: E402

CUSTOM_ELEMENTS = {5: build_dr_elements, 29: _custom_29, 42: _custom_42}
