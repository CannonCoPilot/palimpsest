...
from text_source import project_for  # noqa: E402
# Detector functions (_layout_boundaries/_endnote_separator/detect_layout_sections)
# are imported lazily inside a23()/summary() — the A2/A3 detector-comparison commands.
# The generation path (materialize/RULES/reconcile) needs only project_for.
...
RULES: dict[int, list[dict]] = {
    ...
    # idx5 (Douay-Rheims) is materialized by bible_structure.build_dr_elements
    # (masking_map.CUSTOM_ELEMENTS[5]) — the coarse Chapter-N tiling rules were
    # replaced by a faithful header/argument/body + end-matter model.
    107: [
        {
