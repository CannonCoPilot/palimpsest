...
**R9.6b** · **R10.1** · **R10.2** · **R11.2a** · **R11.2b** · **R11.3a** · **R11.4** · **R11.5** (blocked)
...
../ocr-venv/bin/python witness/audit_prereq_ceilings.py # R10.1: exits 1 -> 20/46 OPEN steps carry a §0.5 ceiling; the fraction must RISE
