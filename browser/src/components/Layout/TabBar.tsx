...
const TABS: { id: TabId; label: string; shortcut: string; tip: string }[] = [
  ...
  { id: 'texthic', label: 'TextHiC', shortcut: 'Alt+2', tip: 'Self-similarity heatmap (Alt+2)' },
  { id: 'characters', label: 'Characters', shortcut: 'Alt+3', tip: 'Entity index and co-occurrence (Alt+3)' },
  { id: 'analysis', label: 'Analysis', shortcut: 'Alt+4', tip: 'Track computation and parameters (Alt+4)' },
];
